...
@endpush
    ...
    <div class="panel panel-default" id="pullout_form">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('saveCreateSTWFBV') }}" method="POST" id="stw_create" autocomplete="off" role="form" enctype="multipart/form-data">
...
function checkStartingNumber(starting_number) {
    if(starting_number == start_code && stack.length === 0){
