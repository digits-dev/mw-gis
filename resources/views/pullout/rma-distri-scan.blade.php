...
@endpush
    ...
    <div class="panel panel-default" id="pullout_form">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('saveCreateRMADistri') }}" method="POST" id="str_create" autocomplete="off" role="form" enctype="multipart/form-data">
                    ...
                    if (data.status_no == 1) {
                        ...
                        if (!in_array(data.items.digits_code, stack) && checkNumber) {
                            ...
                            $('#problems'+data.items.digits_code).change(function () {
                                ...
                                if(prob_details.includes("OTHERS")){ //other
