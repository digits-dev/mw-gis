...
@endpush
    ...
    <div class='panel panel-default'>
        ...
        <h3 class="box-title text-center"><b>Pullout Receiving Form</b></h3>
        </div>

        <div class='panel-body'>

            <form action="{{ route('savePulloutSTWReceiving') }}" method="POST" id="st_received" autocomplete="off" role="form" enctype="multipart/form-data">
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-center scan scanqty{{$item['digits_code']}}">
                                            <input class="form-control text-center rcv_qty" data-id="{{ $item['digits_code'] }}" type="text" name="received_quantity[]" id="qty_{{ $item['digits_code'] }}" value="0" readonly/>
                                        </td>
                                        <td>
...
var serial_array = [];
var pulloutItems = {!! $pullout_items !!}

$(document).ready(function() {
    
    const pItems = JSON.parse(JSON.stringify(pulloutItems));
