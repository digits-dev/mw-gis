...
@endpush
    ...
    <div class='panel panel-default'>
        ...
        <h3 class="box-title text-center"><b>Pullout Pick Confirm</b></h3>
        </div>

        <div class='panel-body'>

            <form action="{{ route('saveSTWOnlinePickConfirm') }}" method="POST" id="st_received" autocomplete="off" role="form" enctype="multipart/form-data">
