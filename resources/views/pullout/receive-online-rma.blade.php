...
@endpush
    ...
    <div class='panel panel-default'>
        ...
        <div class='panel-body'>
            ...
            <form action="{{ route('savePulloutRMAReceiving') }}" method="POST" id="st_received" autocomplete="off" role="form" enctype="multipart/form-data">
            ...
            <input type="hidden" name="from_transfer_rma" id="from_transfer_rma" value="{{ $transfer_from->pos_warehouse_rma }}"/>
            ...
            <input type="hidden" name="from_transfer_branch" id="from_transfer_branch" value="{{ $transfer_from->pos_warehouse_rma_branch }}"/>
