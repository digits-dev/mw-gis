...
@endpush
    ...
    <div class='panel panel-default'>
        ...
        <div class='panel-body'>
            <form action="{{ route('saveReviewMarketingPullout') }}" method="POST" id="approval_pullout" autocomplete="off" role="form" enctype="multipart/form-data">
