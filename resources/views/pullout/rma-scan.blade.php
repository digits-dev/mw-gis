...
@endpush
    ...
    <div class="panel panel-default" id="pullout_form">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('saveCreateRMA') }}" method="POST" id="str_create" autocomplete="off" role="form" enctype="multipart/form-data">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label class="control-label">Pullout Date: <span class="required">*</span></label>
                        <input type='input' required name='pullout_date' id="pullout_date" onkeydown="return false" autocomplete="off" class='form-control' placeholder="yyyy-mm-dd" required/>
                </div>
            </div>
                        ...
                        if (!in_array(data.items.digits_code, stack) && checkNumber) {
                            ...
                            if(has_serial == 1){
                                ...
                                var new_row = '<tr class="nr" id="rowid' + data.items.digits_code + '">' +
                                    '<td><input class="form-control text-center item-code" type="text" name="digits_code[]" readonly value="' + data.items.digits_code + '"><input type="hidden" name="bea_item[]" value="' + data.items.bea_item + '"></td>' +
                                    '<td><input class="form-control" type="text" name="item_description[]" readonly value="' + convert(data.items.item_description) + '"><input type="hidden" name="price[]" value="' + data.items.price + '"></td>' +
