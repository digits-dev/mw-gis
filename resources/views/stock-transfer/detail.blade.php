                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="st-header-1">
                        <tbody>
                            ...
                            @if(!is_null($stDetails->approver) || !empty($stDetails->approver))
                                <tr>
                                    <td width="30%"><b>Approved By:</b></td>
                                    <td>{{ $stDetails->approver }} / {{ $stDetails->approved_at != null ? date('M d, Y',strtotime($stDetails->approved_at)) : "" }}</td>
                                    
                                </tr>
                            @elseif(!is_null($stDetails->rejector) || !empty($stDetails->rejector))
                                <tr>
                                    <td width="30%"><b>Rejected By:</b></td>
                                    <td>{{ $stDetails->rejector }} / {{ $stDetails->rejected_at != null ? date('M d, Y',strtotime($stDetails->rejected_at)) : "" }}</td>
                    ...
                    <table class="table table-bordered" id="st-header-2">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    @if(!empty($stDetails->scheduled_at)) {{ $stDetails->scheduled_at }} @else {{ $stDetails->transfer_date }} @endif  
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 30%">
...
<script type="text/javascript">
    ...
    @elseif($stDetails->status == "CLOSED")
