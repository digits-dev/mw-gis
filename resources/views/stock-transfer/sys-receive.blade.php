        ...
        <div class='panel-body'>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="item_search" id="item_search" disabled/>
                </div>
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($item['st_serial_numbers'] as $serial)
                                                <input class="form-control" id="serial_number_{{$item['digits_code']}}{{$i}}" type="text" name="{{$item['digits_code']}}_serial_number[]" value="{{$serial}}" readonly/>
                                            @endforeach
                                        </td>
                                    </tr>    
                                @endforeach
