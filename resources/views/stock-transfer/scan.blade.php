                        ...
                        if (!in_array(data.items.digits_code, stack)) {
                            ...
                            if(has_serial == 1){
                                ...
                                var new_row = '<tr class="nr" id="rowid' + data.items.digits_code + '">' +
                                    ...
                                    '<td class="scan scanqty' + data.items.digits_code + '" bgcolor="yellow"><input class="form-control text-center scan_qty" type="number" min="0" max="9999" oninput="validity.valid||(value=0);" id="qty_' + data.items.digits_code + '" name="st_quantity[]" readonly value="1" style="">' +
