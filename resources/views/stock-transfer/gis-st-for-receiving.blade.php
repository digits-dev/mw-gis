...
@endpush
    ...
    <div class='panel panel-default'>
        ...
        <h3 class="box-title text-center"><b>Stock Transfer Gis receiving form</b></h3>
        </div>
        <form method='POST' id="receivingForm" action='{{CRUDBooster::mainpath('edit-save/'.$header->gp_id)}}'>
            ...
            <div class='panel-footer'>
                ...
                <button class="btn btn-success pull-right" type="button" id="btnReceive"><i class="fa fa-check-circle" ></i> Receive</button>
            </div>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $('#btnReceive').click(function(event) {
