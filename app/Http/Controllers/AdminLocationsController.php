<?php namespace App\Http\Controllers;
	...
	class AdminLocationsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "location_description";
			$this->limit = "20";
			$this->orderby = "location_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Location Description","name"=>"location_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Location Description','name'=>'location_description','type'=>'text','validation'=>'required|min:3|max:50','width'=>'col-sm-5'];
