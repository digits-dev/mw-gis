<?php namespace App\Http\Controllers;
	...
	class AdminTransactionTypeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->limit = "20";
			$this->orderby = "transaction_type,asc";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Transaction Type','name'=>'transaction_type','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-5'];
