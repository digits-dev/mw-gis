<?php namespace App\Http\Controllers;
	...
	class AdminChannelController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Channel Description','name'=>'channel_description','type'=>'text','validation'=>'required|min:3|max:50','width'=>'col-sm-5'];
