<?php namespace App\Http\Controllers;
	...
	class AdminReasonController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->limit = "20";
			$this->orderby = "pullout_reason,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Transaction Type","name"=>"transaction_type_id","join"=>"transaction_type,transaction_type"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Transaction Type','name'=>'transaction_type_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-5','datatable'=>'transaction_type,transaction_type'];
