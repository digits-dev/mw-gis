<?php namespace App\Http\Controllers;
	...
	class AdminStatusWorkflowsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Workflow Status","name"=>"workflow_status"];
			...
			$this->form[] = ['label'=>'Transaction Type','name'=>'transaction_type','type'=>'select','validation'=>'required','width'=>'col-sm-5','dataenum'=>'STS;STW;RMA'];
			$this->form[] = ['label'=>'Channel','name'=>'channel_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-5','datatable'=>'channel,channel_description'];
			$this->form[] = ['label'=>'Customer Type','name'=>'customer_type','type'=>'select','width'=>'col-sm-5','dataenum'=>'FBD;FBV'];
			$this->form[] = ['label'=>'Transport Type','name'=>'transport_types_id','type'=>'select2','width'=>'col-sm-5','datatable'=>'transport_types,transport_type'];
			$this->form[] = ['label'=>'Workflow Status','name'=>'workflow_status','type'=>'select','validation'=>'required','width'=>'col-sm-5','dataenum'=>'PENDING;FOR PROCESSING;FOR SCHEDULE;FOR PICKLIST;FOR RECEIVING;RECEIVED'];
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        if($button_name == 'set_status_active') {
				StatusWorkflow::whereIn('id',$id_selected)->update([
					'status'=>'ACTIVE', 
